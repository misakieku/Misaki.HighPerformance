...
public class SPMDTest
{
    ...
    public unsafe void TestSPMDVectorDot()
    {
        ...
        JobSPMDUtility.Run<DotProductJob, float>(ref job, count, default);
    ...
    public void TestSPMDVector2Lerp()
    {
        ...
        JobSPMDUtility.Run<Vector2LerpJob, float>(ref job, count, default);
    ...
    public void TestSPMDVector4Normalize()
    {
        ...
        JobSPMDUtility.Run<Vector4NormalizeJob, float>(ref job, count, default);
    ...
    public void TestSPMDVector3Cross()
    {
        ...
        JobSPMDUtility.Run<Vector3CrossJob, float>(ref job, count, default);
    ...
    public void TestSPMDMinMaxClamp()
    {
        ...
        JobSPMDUtility.Run<MinMaxClampJob, float>(ref job, count, default);
    ...
    public void TestSPMDDistance()
    {
        ...
        JobSPMDUtility.Run<DistanceJob, float>(ref job, count, default);
